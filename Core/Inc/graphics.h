 ...
 */
bounding_box_t draw_text(char *string, unsigned char x, unsigned char y,
		unsigned char *font, unsigned char spacing, unsigned char inv);
/**
 ...
 * @param font		The font used to render the text
 */
bounding_box_t draw_char(unsigned char c, unsigned char x, unsigned char y,
		unsigned char *font, unsigned char inv);
/**
 ...
 * @param colour 	0 = OFF, any other value = ON
 */
void draw_circle(unsigned char centre_x, unsigned char centre_y,
		unsigned char radius, unsigned char colour);
/**
 ...
 * @param colour 	0 = OFF, any other value = ON
 */
void draw_filled_circle(unsigned char centre_x, unsigned char centre_y,
		unsigned char radius, unsigned char colour);
/**
 *	draw a array: array format :rows of image must be multiplier of 8
 *		col1	col2	.....	coln(max n=128)
 *		-----------------------------------------
 *	D0	B		B				B
 *	D1	Y		Y				Y
 *	.	T		T				T
 ...
 *		----------------------------------
 */
void draw_bmp_v(unsigned char x, unsigned char y, unsigned char width,
		unsigned char height, unsigned char *pic, unsigned char color);
/**
 *	draw a array: array format :rows of image must be multiplier of 8: m=n/8
 *		col1	col2	.....	col8	....	coln(max n=128)
 *		-----------------------------------------
 *		BY0(D7)	BY0(D6)	....	BYm(D7)	....	BYm(D0)
 *		----------------------------------
 */
void draw_bmp_h(unsigned char x, unsigned char y, unsigned char width,
		unsigned char height, unsigned char *pic, unsigned char color);
